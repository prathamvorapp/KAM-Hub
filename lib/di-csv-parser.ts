...
import { BrandRecord, KAMRecord, PriceRecord, BrandWithKAM, OutletInfo } from './di-types'
...
export class CSVParser {
  ...
  async parseRevenueData(): Promise<import('./di-types').RevenueRecord[]> {
    ...
    try {
      ...
      return result.data
        ...
        .filter((record): record is import('./di-types').RevenueRecord => record !== null)
    } catch (error) {
  ...
  async parseChurnData(): Promise<import('./di-types').ChurnRecord[]> {
    ...
    try {
      ...
      return result.data
        ...
        .filter((record): record is import('./di-types').ChurnRecord => record !== null)
    } catch (error) {
      console.error(`Error parsing ${fileName}:`, error)
      return []
    }
  ...
  async parseExpenseData(): Promise<import('./di-types').ExpenseRecord[]> {
    ...
    try {
      ...
      return result.data
        ...
        .filter((record): record is import('./di-types').ExpenseRecord => record !== null)
    } catch (error) {
      console.error(`Error parsing ${fileName}:`, error)
      return []
    }
